...
// Source: github.com/ONSdigital/dp-download-service/handlers (interfaces: DatasetClient,VaultClient,S3Client,FilterClient,IdentityClient)
...
func (m *MockIdentityClient) CheckRequest(arg0 *http.Request, arg1, arg2 string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "CheckRequest", arg0, arg1, arg2)
}

// CheckRequest indicates an expected call of CheckRequest
func (mr *MockIdentityClientMockRecorder) CheckRequest(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckRequest", reflect.TypeOf((*MockIdentityClient)(nil).CheckRequest), arg0, arg1, arg2)
}
